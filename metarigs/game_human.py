...
def create(obj):  # noqa
    ...
    bone.head = 0.0000, -0.0625, 1.8738
    ...
    bone.head = 0.0000, -0.1627, 1.8429
    bone.tail = 0.0000, -0.2304, 1.8429
    bone.roll = 0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['face']]
    bones['nose_master'] = bone.name
    bone = arm.edit_bones.new('brow.B.L.004')
    bone.head = 0.0221, -0.1397, 1.8950
    ...
    bone.head = -0.0000, -0.0518, 1.7946
    bone.tail = -0.0000, -0.0771, 1.8002
    bone.roll = 0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['jaw_master']]
    bones['tongue'] = bone.name
    bone = arm.edit_bones.new('chin_end_glue.001')
    bone.head = 0.0000, -0.1599, 1.7909
    bone.tail = -0.0000, -0.1667, 1.7978
    bone.roll = 0.7854
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['jaw_master']]
    ...
    bone.head = -0.0000, -0.0771, 1.8002
    bone.tail = 0.0000, -0.1111, 1.7949
    bone.roll = -0.0000
    bone.use_connect = True
    ...
    bone.head = 0.0000, -0.1111, 1.7949
    bone.tail = 0.0000, -0.1334, 1.7673
    bone.roll = -0.0000
    bone.use_connect = True
    ...
    try:
        ...
        pass
    assign_bone_collection_refs(pbone.rigify_parameters, 'skin_secondary', 'Face (Primary)')
    ...
    try:
        ...
        pass
    try:
        pbone.rigify_parameters.skin_chain_falloff = (
            0.699999988079071, 1.0, 0.10000000149011612)
    except AttributeError:
        pass
    try:
    ...
    try:
        ...
        pass
    assign_bone_collection_refs(pbone.rigify_parameters, 'skin_primary', 'Face')
